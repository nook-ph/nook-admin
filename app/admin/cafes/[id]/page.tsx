...
export default function ViewCafePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-0.5">
            <h1 className="text-2xl font-semibold">Slowpoke Coffee</h1>
      ...
      {/* Form in disabled/read-only mode */}
      <CafeEditorForm mode="edit" id={cafeId as string} disabled={true} />
    </div>
  )
}
