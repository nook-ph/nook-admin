...
export default function CreateOwnerAccountPage() {
      ...
      <Card className="bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-800 mb-6">
        <CardContent className="pt-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <p className="font-medium text-sm">Slowpoke Coffee</p>
              <div className="flex items-center gap-1">
                <MapPin className="size-3 text-muted-foreground" />
                <p className="text-xs text-muted-foreground">IT Park, Cebu City</p>
              </div>
            </div>
            <Badge
              variant="outline"
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2 shrink-0">
          <Button variant="outline" asChild>
            <Link href={`/admin/cafes/${cafeId}`}>Cancel</Link>
          </Button>
          <Button
