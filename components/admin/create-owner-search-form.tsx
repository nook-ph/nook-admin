...
function CafeStatusBadge({ status }: { status: string }) {
  if (status === "active") {
    return (
...
interface CreateOwnerSearchFormProps {
  cafes: UnclaimedCafe[]
}

export function CreateOwnerSearchForm({ cafes }: CreateOwnerSearchFormProps) {
